...
distrobox create --name arch --image quay.io/toolbx-images/archlinux-toolbox:latest --yes
...
sudo rm /usr/share/icons/oreo_spark_purple_cursors
sudo rm /usr/share/icons/oreo_spark_purple_cursors
...
sudo rm /usr/share/icons/Bibata-Modern-Amber
